...
public class Messages {
    ...
    public static class Customer {
        ...
        public static final String INDIVIDUAL_CUSTOMER_ALREADY_EXISTS= "Identity number already exists";
        public static final String INDIVIDUAL_CUSTOMER_CREATED = "Individual customer created successfully";
        public static final String EMAIL_ALREADY_EXISTS = "Email already exists";


        public static final String CORPORATE_CUSTOMER_NOT_FOUND = "Corporate customer not found with";
    ...
    public static class Credit {
        ...
        public static final String CREDİT_TYPE_NAME_EXISTS= "Credit type name exists";
